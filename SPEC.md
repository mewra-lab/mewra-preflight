...
| **0.2.0** | **Current** | **Mewra Pounce route summary** (detect changed route declarations, surface route chips in the dashboard, and attach Mermaid route/file summaries to PR drafts), per-folder check-pack overrides (`.preflightignore`)                                                                                                                |
