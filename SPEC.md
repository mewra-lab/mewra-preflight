...
| **0.6.0** | Current  | **Pounce companion integration**: Pounce owns and registers its blast-radius check through the extension API; PreFlight remains a tool-agnostic host and renders contributed route summaries generically.                                                                                                                           |
